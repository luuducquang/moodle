...
echo '.secondary-navigation { display: none; }';
echo '.tertiary-navigation { display: none; }';
echo '.btn.btn-secondary.headerbutton { display: none; }';
echo '.othernav { display: none; }';
echo '.activity-navigation.container-fluid { display: none; }';
echo '.navbar.fixed-top{ display: none; }';
echo '</style>';
